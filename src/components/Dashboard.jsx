...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchCards = async () => {
      try {
        const response = await fetch('https://fund-end.vercel.app/api/dashboard/Shiva/cards'); // Ensure this is your correct API path
  ...
  const handleAddProgress = async (cardId) => {
    ...
    try {
      const response = await fetch(`https://fund-end.vercel.app/api/cards/${cardId}/progress`, {
        method: 'PUT',
        headers: {
